...
def main_galaxy(event):
        ...
        hero = pygame.image.load('media/game_icons/character.png')
        ...
        ufo = pygame.image.load('media/meteors/ufo.png')
        ...
        comet_animations = [
            pygame.image.load("media/meteors/2/2/anim_1.png"),
            pygame.image.load("media/meteors/2/2/anim_2.png"),
            pygame.image.load("media/meteors/2/2/anim_3.png"),
            pygame.image.load("media/meteors/2/2/anim_4.png"),
            pygame.image.load("media/meteors/2/2/anim_5.png"),
            pygame.image.load("media/meteors/2/2/anim_6.png"),
            pygame.image.load("media/meteors/2/2/anim_7.png")
        ]

        animation2 = 0

        comet_animations2 = [
            pygame.image.load('media/meteors/1/anim_1.png'),
            pygame.image.load('media/meteors/1/anim_2.png'),
            pygame.image.load('media/meteors/1/anim_3.png'),
            pygame.image.load('media/meteors/1/anim_4.png'),
            pygame.image.load('media/meteors/1/anim_5.png'),
            pygame.image.load('media/meteors/1/anim_6.png')
        ]

        animation3 = 0
        comet_animations3 = [
            pygame.image.load('media/meteors/3/anim_1.png'),
            pygame.image.load('media/meteors/3/anim_2.png'),
            pygame.image.load('media/meteors/3/anim_3.png'),
            pygame.image.load('media/meteors/3/anim_4.png'),
            pygame.image.load('media/meteors/3/anim_5.png'),
            pygame.image.load('media/meteors/3/anim_6.png'),
            pygame.image.load('media/meteors/3/anim_7.png'),
            pygame.image.load('media/meteors/3/anim_8.png'),
            pygame.image.load('media/meteors/3/anim_9.png')
        ]
...
############################################################################################################
    ...
    #################################################################################################################
          ...
          #  win.blit(bgraund, (0, 0))
            ...
            win.blit(comet_animations[animation // 7], (kamenyka1_x,kamenyka1_y))
            win.blit(comet_animations2[animation2 // 7],(kamenyka2_x,kamenyka2_y))
            win.blit(comet_animations3[animation3 // 7],(kamenyka3_x,kamenyka3_y))
